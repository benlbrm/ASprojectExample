...
export AS_CPU_PATH_2 := C:/projects/GithubExample/Temp//Objects/$(AS_CONFIGURATION)/$(AS_PLC)
...
$(AS_BINARIES_PATH)/$(AS_CONFIGURATION)/$(AS_PLC)/Transfer.lst: \
	FORCE
	@"$(AS_BIN_PATH)/BR.AS.FinalizeBuild.exe" "$(AS_PROJECT_PATH)/GithubExample.apj" -t "$(AS_TEMP_PATH)" -o "$(AS_BINARIES_PATH)" -c "$(AS_CONFIGURATION)" -i "C:/Program Files/BrAutomation/AS41" -S "PC_any"  -all -A "AR000" -pil   -swFiles "$(AS_PROJECT_PATH)/Physical/Simulation/PC_any/Cpu.sw" -C "/RT=1000 /AM=* /SDT=5 /DAIP=10.33.20.107 /REPO=11159 /ANSL=1 /PT=11169" -D "/IF=tcpip /LOPO=11159 /SA=87" -M IA32 -T SG4
